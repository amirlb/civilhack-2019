...
sys.path.append(os.path.abspath('C:/Users/dalya/Documents/civilhack-2019'))


# -- Some general info  about the project -----------------------------------------------------------------------------

#CHNAGEME# Change this to fit your project.
project = u'The Route Angels'
copyright = u'2018, BarakY, NoaR, AmirLB, DalyaG'
author = u'BarakY, NoaR, AmirLB, DalyaG'
...
exclude_patterns = ['documentation/_build']
...
templates_path = ['documentation/_templates']
...
html_logo = '_static/TheRouteAngelsLogo.jpg'
